...
public class CherryTree {
    ...
    public static final RegistryObject<Block> CHERRY_LOG = registerBlock(BLOCKS, "cherry_log",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG))
    );
    public static final RegistryObject<Block> CHERRY_WOOD = registerBlock(BLOCKS, "cherry_wood",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD))
    );
    public static final RegistryObject<Block> STRIPPED_CHERRY_LOG = registerBlock(BLOCKS, "stripped_cherry_log",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG))
    );
    public static final RegistryObject<Block> STRIPPED_CHERRY_WOOD = registerBlock(BLOCKS, "stripped_cherry_wood",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_WOOD))
    );

    public static final RegistryObject<Block> CHERRY_PLANKS = registerBlock(BLOCKS, "cherry_planks",
    ...
    public static final RegistryObject<Block> CHERRY_LEAVES = registerBlock(BLOCKS, "cherry_leaves",
    ...
    public static final RegistryObject<Block> CHERRY_SAPLING = registerBlock(BLOCKS, "cherry_sapling",
