...
public class OrangeTree {
    ...
    public static final RegistryObject<Block> ORANGE_BUTTON = registerBlock(
            BLOCKS, "orange_button",
            () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON))
    );
    public static final RegistryObject<Block> ORANGE_FENCE = registerBlock(
            BLOCKS, "orange_fence",
            () -> new FenceBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE))
    );
    public static final RegistryObject<Block> ORANGE_FENCE_GATE = registerBlock(
            BLOCKS, "orange_fence_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE))
    );
    public static final RegistryObject<Block> ORANGE_LOG = registerBlock(
            BLOCKS, "orange_log",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG))
    );
    public static final RegistryObject<Block> ORANGE_LEAVES = registerBlock(
    ...
    public static final RegistryObject<Block> ORANGE_PRESSURE_PLATE = registerBlock(
            BLOCKS, "orange_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,
                    BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE))
    );
    public static final RegistryObject<Block> ORANGE_SAPLING = registerBlock(
            BLOCKS, "orange_sapling",
            () -> new SaplingBlock(new OrangeTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING))
    );
    public static final RegistryObject<Block> ORANGE_SLAB = registerBlock(
            BLOCKS, "orange_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SLAB))
    );
    public static final RegistryObject<Block> ORANGE_STAIRS = registerBlock(
            BLOCKS, "orange_stairs",
            () -> new StairBlock(() -> ORANGE_PLANKS.get().defaultBlockState(),
                    BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS))
    );
    public static final RegistryObject<Block> ORANGE_WOOD = registerBlock(
            BLOCKS, "orange_wood",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD))
    );
    public static final RegistryObject<Block> STRIPPED_ORANGE_LOG = registerBlock(
            BLOCKS, "stripped_orange_log",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG))
    );
    public static final RegistryObject<Block> STRIPPED_ORANGE_WOOD = registerBlock(
            BLOCKS, "stripped_orange_wood",
