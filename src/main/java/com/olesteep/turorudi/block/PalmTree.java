...
public class PalmTree {
    ...
    public static final RegistryObject<Block> PALM_PRESSURE_PLATE = registerBlock(
            BLOCKS, "palm_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,
                    BlockBehaviour.Properties.copy(Blocks.JUNGLE_PRESSURE_PLATE))
    );
    public static final RegistryObject<Block> PALM_SAPLING = registerBlock(
            BLOCKS, "palm_sapling",
            () -> new TuroSaplingBlock(new PalmTreeGrower(),
                    BlockBehaviour.Properties.copy(Blocks.JUNGLE_SAPLING), () -> Blocks.SAND)
    );
