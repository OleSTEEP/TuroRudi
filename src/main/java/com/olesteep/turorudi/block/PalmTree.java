...
public class PalmTree {
    ...
    public static final RegistryObject<Block> PALM_WOOD = registerBlock(BLOCKS, "palm_wood",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_WOOD))
    );
    public static final RegistryObject<Block> STRIPPED_PALM_LOG = registerBlock(BLOCKS, "stripped_palm_log",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_JUNGLE_LOG))
    );
    public static final RegistryObject<Block> STRIPPED_PALM_WOOD = registerBlock(BLOCKS, "stripped_palm_wood",
            () -> new TuroFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_JUNGLE_WOOD))
    );

    public static final RegistryObject<Block> PALM_PLANKS = registerBlock(BLOCKS, "palm_planks",
    ...
    public static final RegistryObject<Block> PALM_LEAVES = registerBlock(BLOCKS, "palm_leaves",
