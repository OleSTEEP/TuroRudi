...
public class TuroLists {
    ...
    public static Item getRandGood() {
        Item[] list = {Alexandrov.ALEX_VANILLA_5.get(),
                Alexandrov.ALEX_VANILLA_26.get(),
                Alexandrov.ALEX_CHOCOLESS.get(),
                Alexandrov.ALEX_COND.get(),
                Alexandrov.ALEX_MILK_5.get(),
                Alexandrov.ALEX_MILK_26.get(),
                ...
                Nostalgia.NOSTALGIA_VANILLA_23.get(),
                Nostalgia.NOSTALGIA_VANILLA_5.get(),
                Nostalgia.NOSTALGIA_BERRY.get(),
                Nostalgia.NOSTALGIA_CHERRY.get(),
                Nostalgia.NOSTALGIA_COND.get(),
                Nostalgia.NOSTALGIA_POTATO.get(),
                ...
                Sirkoff.SIRKOFF_VANILLA.get(),
                Sirkoff.SIRKOFF_COCO.get(),
                Sirkoff.SIRKOFF_COND.get(),
                Sirkoff.SIRKOFF_STRAW.get(),
                Sirkoff.SIRKOFF_POTATO.get(),
                SovietTraditions.SOVIET_VANILLA.get(),
                SovietTraditions.SOVIET_CARAMEL.get(),
                SovietTraditions.SOVIET_COCOA.get(),
                SovietTraditions.SOVIET_COND.get(),
