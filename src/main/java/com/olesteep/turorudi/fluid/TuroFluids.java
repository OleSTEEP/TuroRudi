...
public class TuroFluids {
    ...
    public static final RegistryObject<FlowingFluid> MILK_COND_FLUID = FLUIDS.register(
            "milk_condensed",
            () -> new ForgeFlowingFluid.Source(TuroFluids.MILK_COND_PROPERTIES)
    );
    public static final RegistryObject<FlowingFluid> MILK_COND_FLOWING = FLUIDS.register(
    ...
    public static final ForgeFlowingFluid.Properties MILK_COND_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .block(() -> TuroFluids.MILK_COND_BLOCK.get())
            .bucket(() -> TuroItems.MILK_COND_BUCKET.get()
            );
    public static final RegistryObject<LiquidBlock> MILK_COND_BLOCK = registerBlockWithoutItem(
            TuroBlocks.BLOCKS,
            "milk_cond",
            () -> new CondensedMilkFluidBlock(() -> TuroFluids.MILK_COND_FLUID.get(),
