...
public class Alexandrovs {
    ...
    public static final RegistryObject<Item> ALEX_VANILLA26 = ITEMS.register("alexandrov26",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_VANILLA_FAT)));

    public static final RegistryObject<Item> ALEX_CHOCOLESS = ITEMS.register("alexandrov_chocoless",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_VANILLA_CHOCOLESS)));
    ...
    public static final RegistryObject<Item> ALEX_MILK5 = ITEMS.register("alexandrov_milk5",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_VANILLA_MILK)));

    public static final RegistryObject<Item> ALEX_MILK26 = ITEMS.register("alexandrov_milk26",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_VANILLA_FAT_MILK)));
    ...
    public static final RegistryObject<Item> ALEX_SOUFFLE = ITEMS.register("alexandrov_souffle",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_SOUFFLE)));

    public static final RegistryObject<Item> ALEX_SOUFFLE_MILK = ITEMS.register("alexandrov_souffle_milk",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_SOUFFLE_MILK)));

    public static final RegistryObject<Item> ALEX_WHITE = ITEMS.register("alexandrov_white",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.TUROTAB).food(ModFoods.TURO_WHITE)));
