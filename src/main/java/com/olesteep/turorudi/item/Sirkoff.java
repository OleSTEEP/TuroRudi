...
public class Sirkoff {
    ...
    public static final RegistryObject<Item> SIRKOFF_STRAW = ITEMS.register("sirkoff_strawberry", () -> new Item(new Item.Properties().tab(TuroCreativeTabs.SNACKTAB).food(TuroFoods.TURO_STRAW)));
