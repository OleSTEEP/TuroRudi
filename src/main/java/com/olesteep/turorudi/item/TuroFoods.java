...
public class TuroFoods {
    ...
    public static final FoodProperties TURO_BERRY = (new FoodProperties.Builder()).nutrition(12).saturationMod(1.0F).effect(new MobEffectInstance(MobEffects.REGENERATION, 3400, 0), 1.0F).build();
