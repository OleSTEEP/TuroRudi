...
public class TuroItems {
    ...
    public static final RegistryObject<Item> TURORUDI = ITEMS.register("turorudi",
            () -> new Item(new Item.Properties().food(TuroFoods.TURO_BASE).tab(TuroCreativeTab.TUROTAB)));
    ...
    public static final RegistryObject<Item> BLBERRY = ITEMS.register("blueberry",
            () -> new ItemNameBlockItem(BlueBerryBush.BLBERRY_BUSH.get(),
                    (new Item.Properties()).food(TuroFoods.BLBERRY).tab(TuroCreativeTab.TUROTAB)));
    ...
    public static final RegistryObject<Item> CHOCOLATE_BAD = ITEMS.register("chocolate_bad",
            () -> new Item(new Item.Properties().food(TuroFoods.CHOCOLATE_BAD).tab(TuroCreativeTab.TUROTAB)));
    ...
    public static final RegistryObject<Item> CURD_BAD = ITEMS.register("curd_bad",
            () -> new Item(new Item.Properties().food(TuroFoods.CURD_BAD).tab(TuroCreativeTab.TUROTAB)));

    public static final RegistryObject<Item> GLAZE = ITEMS.register("glaze",
            () -> new Item(new Item.Properties().food(TuroFoods.GLAZE).tab(TuroCreativeTab.TUROTAB)));
    ...
    public static final RegistryObject<Item> MILK_FAT = ITEMS.register("milk_fat",
            () -> new Item(new Item.Properties().food(TuroFoods.MILK_FAT).tab(TuroCreativeTab.TUROTAB)));

    public static final RegistryObject<Item> LEMON = ITEMS.register("lemon",
            () -> new Item(new Item.Properties().food(TuroFoods.LEMON).tab(TuroCreativeTab.TUROTAB)));

    public static final RegistryObject<Item> ORANGE = ITEMS.register("orange",
            () -> new Item(new Item.Properties().food(TuroFoods.ORANGE).tab(TuroCreativeTab.TUROTAB)));
