...
public class TuroVillagers {
    ...
    public static final RegistryObject<PoiType> TUROMAKER_POI = POI_TYPES.register("turomaker_poi", () -> new PoiType("turomaker_poi", PoiType.getBlockStates(Blocks.ENDER_CHEST), 1, 1));
