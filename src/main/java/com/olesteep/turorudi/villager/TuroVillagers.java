...
public class TuroVillagers {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == TuroVillagers.TUROMAKER.get()) {
            ...
            trades.get(2).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, nonNullRandom(6)), new ItemStack(TuroFluidCondensedMilkHolder.BUCKET.get(), 1),4,12,0.18F));
            ...
            trades.get(2).add((trader, rand) -> new MerchantOffer(new ItemStack(TuroFluidCondensedMilkHolder.BUCKET.get(), 1), new ItemStack(Items.EMERALD, nonNullRandom(6)),4,12,0.09F));
