...
public class TuroConfiguredFeatures {
    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> PATCH_APRICOT_BUSH =
            FeatureUtils.register("patch_apricot_bush", Feature.RANDOM_PATCH,
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> PALM_TREE =
            FeatureUtils.register("palm", Feature.TREE, new TreeConfigurationBuilder(
                    BlockStateProvider.simple(PalmTree.PALM_LOG.get()),
                    new ForkingTrunkPlacer(5, 2, 2),
                    BlockStateProvider.simple(PalmTree.PALM_LEAVES.get()),
                    new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)),
                    new TwoLayersFeatureSize(1, 0, 2))
                    .dirt(BlockStateProvider.simple(Blocks.SAND)).ignoreVines()
                    .decorators(ImmutableList.of(new CoconutDecorator(0.2F),
                            new BananaDecorator(0.2F))).build());
    ...
    public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> PALM_SPAWN =
            FeatureUtils.register("palm_spawn", Feature.RANDOM_SELECTOR,
                    new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(PALM_CHECKED,
                            0.5F)), PALM_CHECKED));
}
