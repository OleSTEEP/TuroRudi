...
public class TuroPlacedFeatures {
    public static final Holder<PlacedFeature> APRICOT_BUSH_PLACED = PlacementUtils.register("apricot_bush_placed", TuroConfiguredFeatures.PATCH_APRICOT_BUSH, RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
    public static final Holder<PlacedFeature> BLBERRY_BUSH_PLACED = PlacementUtils.register("blueberry_bush_placed", TuroConfiguredFeatures.PATCH_BLBERRY_BUSH, RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
    public static final Holder<PlacedFeature> CHERRY_PLACED = PlacementUtils.register("cherry_placed", TuroConfiguredFeatures.CHERRY_SPAWN, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.025f, 1)));
