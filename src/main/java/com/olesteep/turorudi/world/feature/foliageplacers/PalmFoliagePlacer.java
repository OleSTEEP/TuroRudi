...
public class PalmFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(@NotNull LevelSimulatedReader worldReader, @NotNull BiConsumer<BlockPos, BlockState> acceptedLocations, @NotNull RandomSource random, @NotNull TreeConfiguration treeConfiguration, int p_161350_, FoliagePlacer.FoliageAttachment attachment, int height, int radius, int p_161354_) {
    ...
    public int foliageHeight(@NotNull RandomSource random, int height, @NotNull TreeConfiguration treeConfiguration) {
        return 0;
    }

    protected boolean shouldSkipLocation(@NotNull RandomSource random, int p_68383_, int p_68384_, int p_68385_, int p_68386_, boolean p_68387_) {
        if (p_68384_ == 0) {
