...
public class PalmFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(LevelSimulatedReader WorldReader, BiConsumer<BlockPos, BlockState> AcceptedLocations, RandomSource Rand, TreeConfiguration TreeConf, int p_161350_, FoliagePlacer.FoliageAttachment p_161351_, int p_161352_, int p_161353_, int p_161354_) {
    ...
    public int foliageHeight(RandomSource Rand, int p_68390_, TreeConfiguration TreeConf) {
        return 0;
    }

    protected boolean shouldSkipLocation(RandomSource p_68382_, int p_68383_, int p_68384_, int p_68385_, int p_68386_, boolean p_68387_) {
        if (p_68384_ == 0) {
