...
public class TuroFoliagePlacerType {
    public static final DeferredRegister<FoliagePlacerType<?>> FOLIAGE = DeferredRegister.create(
            ForgeRegistries.FOLIAGE_PLACER_TYPES,
            TuroRudi.MOD_ID
    );

    public static final RegistryObject<FoliagePlacerType<?>> PALM_FOLIAGE_PLACER = FOLIAGE.register(
            "palm_foliage",
